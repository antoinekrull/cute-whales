...
-- insert picture of temperature data --
...
Through this heatmap, wecan seee that the majority of the values for both regions are close to zero. This suggests a weaker correlation between temperature and deaths across different months of the year.
